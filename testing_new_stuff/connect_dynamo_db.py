# conncet Dynamo DB
# See this: https://github.com/santoshghimire/boto3-examples
...
if __name__ == '__main__':
    ...
    # result = mydb.create_table(table_name='Data-Store', hash_name='MyKey')

    # Try inserting an item:
    # result = mydb.insert_item(table_name='Data-Store', item={'MyKey': 'myid'})

    # delete the item again:
    # result = mydb.delete_item(table_name='Data-Store', item_key={'name': 'MyKey', 'value': 'myid'})
    # result = mydb.delete_all_items(table_name='Data-Store', hash_name='MyKey')

    # mydb.get_item(table_name='Data-Store', query_item={'MyKey': 'myid'})
    # you cannot update the key but any other value:
    # mydb.update_item(table_name='Data-Store', key_dict={'MyKey': 'myid'}, update_dict={'attribute': 'feature2', 'value': 'mynewid2'})

    # write a bunch of stuff at once:
    # mydb.batch_write(table_name='Data-Store', items=[{'MyKey': 'myid'}, {'MyKey': 'myid2'}, {'MyKey': 'myid4'}])

    result = mydb.scan_item(table_name='Data-Store', attr1={'name': 'MyKey', 'value': 'myid'}, attr2={'name': 'feature2', 'value': 'mynewid2'})
