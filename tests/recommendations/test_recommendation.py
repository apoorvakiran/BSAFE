...
class TestRecommendation(unittest.TestCase):
    ...
    def test_recommendation_lattice(self):
        payload_dict1 = dict(
            safety_score=[0, 0, 0], speed_score=[0, 0, 0], posture_score=[0, 0, 0]
        )
        rec = recommend.Recommendation(
            payload_dict=payload_dict1,
            rec_dic=recommend.default_rec_dic,
        ...
        self.assertEqual(
            {1: False, 2: False, 3: False, 4: False, 5: False, 6: False}, lattice
        )
    ...
    def test_recommendation_lattice2(self):
        ...
        self.assertEqual(
            {1: True, 2: False, 3: False, 4: True, 5: True, 6: False}, lattice2
        )
