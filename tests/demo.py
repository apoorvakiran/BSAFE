...
host = (
    "search-kinesis-cassia-test-ethsitlodguxwer6jtk7uozfkm.us-east-1.es.amazonaws.com"
)
awsauth = AWS4Auth(
    "AKIAXTRZXZRUUGVCREU5",
    "3h2BOZmyNs1KDcMDxA/y9wjfl/xRQ0Xq1g060dTH",
    "us-east-1",
    "es",
)
es = Elasticsearch(
...
raw_data = raw_data.astype(dict(zip(data_column_names, data_column_types)))
