# -*- coding: utf-8 -*-
"""Load a local Elastic Search database with data.

Test that the ES server has data in your browser with:
>> http://localhost:9200/iterate-labs-local-poc/_search?pretty=true&q=*:*

That returns all data.
If the index is "iterate-labs-local-poc".
