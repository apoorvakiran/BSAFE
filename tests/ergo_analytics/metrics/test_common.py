...
def test_custom_weighted_sum():
    ...
    score = custom_weighted_sum(list_of_bins=list_of_bins, weighing_method="constant")
...
def test_strain_score():
    ...
    assert strain_score == {
        "yaw_raw": 5.016042780748664,
        "pitch_raw": 0.2121212121212121,
        "roll_raw": 0.2121212121212121,
        "yaw": 5.016042780748664,
        "pitch": 0.2121212121212121,
        "roll": 0.2121212121212121,
        "total": 5.016042780748664,
    }
    ...
    assert strain_score == {
        "yaw_raw": 6.857142857142858,
        "pitch_raw": 0.2121212121212121,
        "roll_raw": 0.2121212121212121,
        "yaw": 6.857142857142858,
        "pitch": 0.2121212121212121,
        "roll": 0.2121212121212121,
        "total": 6.857142857142858,
    }
    ...
    assert strain_score == {
        "yaw_raw": 6.222222222222222,
        "pitch_raw": 0.2121212121212121,
        "roll_raw": 0.2121212121212121,
        "yaw": 6.222222222222222,
        "pitch": 0.2121212121212121,
        "roll": 0.2121212121212121,
        "total": 6.222222222222222,
    }
    ...
    assert strain_score == {
        "yaw_raw": 0.3187855787476281,
        "pitch_raw": 0.2121212121212121,
        "roll_raw": 0.2121212121212121,
        "yaw": 0.3187855787476281,
        "pitch": 0.2121212121212121,
        "roll": 0.2121212121212121,
        "total": 0.3187855787476281,
    }
...
def test_strain_linear_weights():
    ...
    score = custom_weighted_sum(list_of_bins=list_of_bins, weighing_method="linear")
    assert score == 4
...
def test_strain_quadratic_weights():
    ...
    list_of_bins = [0, 0, 0, 0, 0.5]
    score = custom_weighted_sum(list_of_bins=list_of_bins, weighing_method="quadratic")
    assert score == 4
...
def test_normalize_to_scale():
    ...
    values = [0, 10, 5]
    new_values = normalize_to_scale(
        old_lo=0, old_hi=10, new_lo=2, new_hi=6, values=values
    )
    ...
    values = [20, 40, 100]
    new_values = normalize_to_scale(
        old_lo=10, old_hi=200, new_lo=0, new_hi=1, values=values
    )
    ...
    values = [10]
    new_values = normalize_to_scale(
        old_lo=10, old_hi=20, new_lo=80, new_hi=120, values=values
    )
...
def test_compute_binned_score():
    ...
    score = compute_binned_score(bins=bins, values=values, weighing_method="constant")
    assert score == 0
