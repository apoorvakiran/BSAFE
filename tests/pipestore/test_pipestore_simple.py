...
class TestPipestore(unittest.TestCase):
    ...
    def test_pipestore(self):
        ...
        _ = pipeline.run(on_raw_data=raw_data, with_format_code=data_format_code, num_rows_per_chunk=100)
    ...
    def test_delete(self):
        ...
        _ = pipeline.run(on_raw_data=raw_data, with_format_code=data_format_code,
